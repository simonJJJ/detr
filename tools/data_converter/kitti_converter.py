...
def create_kitti_info_file(data_path,
    ...
    pickle.dump(kitti_infos_train, filename, protocol=2)
    ...
    pickle.dump(kitti_infos_val, filename, protocol=2)
    filename = save_path / f'{pkl_prefix}_infos_trainval.pkl'
    print(f'Kitti info trainval file is saved to {filename}')
    pickle.dump(kitti_infos_train + kitti_infos_val, filename)
    ...
    pickle.dump(kitti_infos_test, filename, protocol=2)
...
def _create_reduced_point_cloud(data_path,
    ...
    """
    kitti_infos = pickle.load(info_path)

    for info in tqdm(kitti_infos, desc="create reduced points"):
        pc_info = info['point_cloud']
        image_info = info['image']
        calib = info['calib']
